...
class PathManager(object):
	...
	def __path(self):
		#$1
		self.path_baselinens = os.path.join(self.home_path,'baselines')  
		#$3   
		...
		#$5
		self.path_algorithm = os.path.join(self.path_baselinens,self.algorithm) #current baseline homepath
		#$7
